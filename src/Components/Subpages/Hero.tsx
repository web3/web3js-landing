...
import { blogPostv4, discordUrl, docsUrl, npmUrl } from '../../urls';
      ...
      <div className={classes.leftColumn}>
        <div className={classes.columnContentWrapper}>
          <img
            ...
            src={web3js}
            alt='Abstract pattern of gemoetric shapes'
          />
          <Typography
            variant='h3'
            className={clsx(classes.reduceLeading, classes.titleText)}>
      ...
      <div className={classes.rightColumn}>
        <div className={classes.columnContentWrapper}>
          <div className={classes.testCard}>
            <img src={hero} alt='Abstract pattern of gemoetric shapes' />
          </div>
          <Typography
            variant='h1'
            className={clsx(
